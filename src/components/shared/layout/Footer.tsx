          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/products/koala-image-directory" className="text-sm text-gray-300 hover:text-white">
                    Koala Image directory
                  </a>
                </li>
                <li>
                  <a href="/products/compare-koala-images" className="text-sm text-gray-300 hover:text-white">
